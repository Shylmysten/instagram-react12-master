...
export const CREATE_POSTS = gql`
    mutation createPosts($userId: uuid!, $media: String!, $location: String!, $caption: String!) {
...
export const UNFOLLOW_USER = gql`
    mutation unfollowUser($userIdToFollow: uuid!, $currentUserId: uuid!) {
        ...
        delete_notifications(where: {user_id:{_eq: $currentUserId}, profile_id:{_eq: $userIdToFollow}, type:{_eq: "unfollow"}}) {
        affected_rows
        }
    }
`;
